...
public class PawnFaye : Pawn {
	...
	/*private void setNodes(ChessPiece t){
		...
		if (south) {
			nodePosition1 = new Vector3 (-0.5f, 0, 0.5f);
			nodePosition2 = new Vector3 (0.5f, 0.5f, 0.5f);
			nodePosition3 = new Vector3 (0.5f, 0, -0.5f);
			nodePosition4 = new Vector3 (0, 0.8f, -0.5f);//in front
		} 
		else if (east) {
			nodePosition1 = new Vector3 (-0.5f, 0, -0.5f);
			nodePosition2 = new Vector3 (-0.5f, 0.5f, 0.5f);
			nodePosition3 = new Vector3 (0.5f, 0, 0.5f);
			nodePosition4 = new Vector3 (0.5f, 0.8f, 0);//in front
		} 
		else if (west) {
			nodePosition1 = new Vector3 (0.5f, 0, 0.5f);
			nodePosition2 = new Vector3 (0.5f, 0.5f, -0.5f);
			nodePosition3 = new Vector3 (-0.5f, 0, -0.5f);
			nodePosition4 = new Vector3 (-0.5f, 0.8f, 0);
		} 
		else if (northeast) {
			 nodePosition1 = new Vector3 (0.5f, 0, -0.5f);
			 nodePosition2 = new Vector3 (-0.5f, 0.5f, -0.5f);
			 nodePosition3 = new Vector3 (-0.5f, 0, 0.5f);
			 nodePosition4 = new Vector3 (0.5f, 0.8f, 0.5f);
		}
		else if (northwest) {
			nodePosition1 = new Vector3 (0.5f, 0, 0.5f);
			nodePosition2 = new Vector3 (0.5f, 0.5f, -0.5f);
			...
			nodePosition2 = new Vector3 (-0.5f, 0.5f, -0.5f);
			nodePosition3 = new Vector3 (-0.5f, 0, 0.5f);
			nodePosition4 = new Vector3 (0, 0.8f, 0.5f);
		}
		...
		tweenPath.nodes [4] = nodePosition4;
	}*/
